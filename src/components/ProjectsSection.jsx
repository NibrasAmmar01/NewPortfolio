...
const projects = [
  {
    id: 1,
    title: "Intrinsica – AI Multimedia Forensics",
    description:
      "Built a multimedia forensics platform for detecting AI-generated images using machine learning and computer vision. The system runs locally and provides visual evidence, explanations, calibration, and uncertainty handling instead of relying on a black-box prediction.",
    image: "/projects/Intrinsica.png",
    tags: [
      "Python",
      "Machine Learning",
      "Computer Vision",
    ...
    github: "https://github.com/montassar-laboudi/Intrinsica",
  },
  {
    id: 2,
    title: "AI SEO Content Agent",
    description:
      "Developed an AI agent that automates the SEO content workflow, from company and competitor research to content generation and direct WordPress publishing through APIs.",
    image: "/projects/LeadGenAgent.png",
    tags: [
      "Python",
      "LLM",
      "AI Agents",
    ...
    github: "https://github.com/NibrasAmmar01/leadgen-agent",
  },
  {
    id: 3,
