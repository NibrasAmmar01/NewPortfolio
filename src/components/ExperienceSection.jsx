...
export const ExperienceSection = () => {
  const experiences = [
    ...
    description:
      "Develop and maintain a production backend microservice for a hospitality software platform. Design and implement REST APIs, business workflows, and PostgreSQL integrations while ensuring scalability, maintainability, and reliable production deployments.",
    technologies: [
      "Java",
      "Spring Boot",
      "PostgreSQL",
  ...
  {
    title:
      "Large-Scale Application Refactoring and Migration",
    role: "Freelance Software Engineer – GenieOps",
    company: "Tunisia",
    period: "December 2025 – January 2026",
    description:
      "Refactored and modernized a large-scale application originally generated by Lovable. Redesigned the database schema, migrated the backend to Supabase, restructured the React frontend, fixed critical bugs, implemented new features, and significantly reduced technical debt.",
    technologies: [
      "ReactJS",
      "TypeScript",
      "Supabase",
